...
@section('content')
  ...
  {{-- PAGINA INICIAL --}}
  <section  style="background-image:url('./img/backgrounds/fondo6.jpg');" class="overlay bgded index" >
    <div id="pageintro" class="hoc clear text-center">
      <article class="p-5">
  ...
  <section style="background-image:url('./img/backgrounds/fondo2.jpg');" class="overlay" >
    <div class='bgded  container'>
      <div class="card-group">
        <div class="card">
          <img class="card-img-top" src="https://tattooadicts.com/wp-content/uploads/1-1.png " alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title text-center">DISEÑOS PERSONALIZADOS DE TATUAJES</h5>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title text-center">DIFERENTES ESTILOS DE TATUAJES
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title text-center">ARTISTAS DEL TATUAJE LOCALES E INTERNACIONALES</h5>
